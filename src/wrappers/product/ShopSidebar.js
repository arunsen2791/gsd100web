  ...
  return (
    <div className={`sidebar-style ${sideSpaceClass ? sideSpaceClass : ""}`}>
      ...
      <ShopPrice
        ...
        priceobj={pricerangecallbackmiddle}
      />
      ...
      <ShopColor
        colors={colors}
        getSortParams={getSortParams}
        getonecolor={colorcallbackMiddle}
      />
      ...
      <ShopSize
        sizes={sizes}
        getSortParams={getSortParams}
        getonesize={sizecallbackMiddle}
      />

      <ShopBrand
        brands={brand}
        getSortParams={getSortParams}
        getonebrand={brandcallbackMiddle}
      />
